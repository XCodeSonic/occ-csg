...
function apiStudent(int $qrVersion = 1, string $studentNumber = '2023105413', string $username = 'jcruz'): Student
{
...
it('records a scan for an authenticated staff member', function () {
    $staff = apiStudent(studentNumber: '2020100001', username: 'staffuser');
